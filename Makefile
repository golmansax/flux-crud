...
codeclimate:
	istanbul cover ./node_modules/.bin/_mocha --compilers js:babel/register --report lcovonly -- -R spec && ./node_modules/.bin/codeclimate-test-reporter < ./coverage/lcov.info
